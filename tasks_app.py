    ...
    if pasirinkimas == "2":  # antras pasirinkimas
        ...
        while True:
            ...
            if pasirinkimas_2_1 == 0:
                ...
                # if pasirinkimas_2_1 == int(list(to_do.keys()).index(list(to_do.keys())[int(pasirinkimas_2_1)])) + 1:
                #     while True:
                #         print(
                #             f'{list(to_do.keys())[pasirinkimas_2_1]} {list(to_do.values())[pasirinkimas_2_1]}')
                #         pasirinkimas_2_2 = int(input(
                #             'ar norite istrinti - 1, ar pakeisti uzduoties statusa? - 2, ar gryzti - 0'))

                #         if pasirinkimas_2_2 == '0':
                #             break
